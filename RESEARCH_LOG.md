...
#### 물리적 결과
**각도 분산**:
- 최소 출사각: -171.30° (λ = 170.2nm)
- 최대 출사각: -125.42° (λ = 145nm)
...
#### 상세 분석 테이블 (대표값)
| λ (nm) | n     | k     | Exit (°) | T (%)   | Path (nm) |
|--------|-------|-------|----------|---------|-----------|
| 145.0  | 1.144 | 1.226 | -125.42  | 0.0026  | 99.2      |
| 163.3  | 1.681 | 1.157 | -169.38  | 0.0060  | 109.1     |
| 170.2  | 1.718 | 1.022 | -171.30  | 0.0260  | 109.4     |
| 186.2  | 1.565 | 0.909 | -162.69  | 0.1339  | 107.8     |
| 200.0  | 1.483 | 1.087 | -157.26  | 0.0681  | 106.7     |
